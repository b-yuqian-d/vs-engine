...
function createDataFolder(args: ServerParsedArgs) {
...
export function parseServerArgs(): ServerParsedArgs {
 ...
 */
export async function spawnCli(args: ServerParsedArgs) {
	const dataFolder = createDataFolder(args);
	await runCli(args, dataFolder, serverOptions);
}
